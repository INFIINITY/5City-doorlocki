...
Doorlock.Show = function(data) {
  ...
  if (data.text == 'closed') {
      CurrentClass = 'error'
      $notification.append('<div class="alert-detail"><span> Zamknięte</span></div>');
  } else if (data.text == 'closed-auth') {
      CurrentClass = 'error'
      $notification.append('<div class="alert-detail"><span> [E] Zamknięte</span></div>');
  } else if (data.text == 'open') {
      CurrentClass = 'success'
      $notification.append('<div class="alert-detail"><span> Otwarte</span></div>');
  } else if (data.text == 'open-auth') {
      CurrentClass = 'success'
      $notification.append('<div class="alert-detail"><span> [E] Otwarte</span></div>');
  }
