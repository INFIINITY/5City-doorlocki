...
AddEventHandler('esx:playerLoaded', function()
 Citizen.SetTimeout(1000, function()
	TriggerEvent('esx:getSharedObject', function(obj) ESX = obj end)
	 Citizen.Wait(250)
	 ESX.TriggerServerCallback("5City-Doorlocki:server:get:config", function(config)
		Config = config
	end)
	Citizen.Wait(150)
	LoggedIn = true
...
RegisterNetEvent('5City-Doorlocki:client:change:door:looks')
AddEventHandler('5City-Doorlocki:client:change:door:looks', function(Door, Type)
...
RegisterNetEvent('5City-Doorlocki:server:reset:door:looks')
...
RegisterNetEvent('5City-Doorlocki:client:setState')
AddEventHandler('5City-Doorlocki:client:setState', function(Door, state)
...
function SetDoorLock(Door, key)
 ...
 SetTimeout(1000, function()
   ...
   TriggerServerEvent('5City-Doorlocki:server:updateState', key, Door['Locked'])
 end)
end
...
function ChangeDoorLooks(Door, Type)
	TriggerServerEvent('5City-Doorlocki:server:change:door:looks', Door, Type)
end